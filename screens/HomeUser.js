    ...
    <View flex={1} bg="blueGray.900">
          ...
          <View px="2" mt="2">
            ...
            <HStack alignItems="center" space="2">
              <Pressable
                ...
                justifyContent="center"
                alignSelf="center"
                onPress={() => handleCallPress("97470082")}
              >
                <Ionicons name="warning" size={60} color="white" />
                <Text mt="1" fontFamily="Bold">
                  Call Supervisor
                </Text>
              </Pressable>
              <Pressable
            ...
            {actifSession == null ? (
              ...
              >
                <View>
                  ...
                  <Text fontFamily="Light" fontSize="xs" color="blueGray.300">
              ...
              <View>
                <SessionChrono getSessions={getSessions} />
      ...
      {showFallModal && (
        <FallModal
          ...
          closeHandler={() => setShowFallModal(false)}
        />
      )}
    </View>
  );
